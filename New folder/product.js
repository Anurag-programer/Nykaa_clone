...
fetch('product.json').then(response => {
 ...
 function setnewimg(){
    document.getElementById("prodimgage").src = "/img/detailimg1.jpg";
 }

 function setnewimg1(){
    document.getElementById("prodimgage").src = "/img/detailimg2.jpg";
 }
 function setnewimg2(){
    document.getElementById("prodimgage").src = "/img/detailimg3.jpg";
 }
 function setoldimg(){
    document.getElementById("prodimgage").src = "./img/img1.jpg";
 }
